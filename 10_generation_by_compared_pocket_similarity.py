...
# 文件夹路径
folder_path = './selected_base_pdb_pocket'  # 替换为实际的文件夹路径
...
##########################################################################################################################
                            ...
                            # 选取第2、4列并另存为csv文件
                            top_1000_rows.to_csv('./result/KIT/KIT_selected_pdbfile_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            ...
                            fragments_df.to_csv('./result/KIT/KIT_fragments_file_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            
                            # 将碎片库单独另存为csv文件
                            fragment_library = list(set(fragments_df['fragment'].tolist()))
                            fragment_library_df = pd.DataFrame(fragment_library, columns=['fragment'])
                            fragment_library_df.to_csv('./result/KIT/KIT_fragment_library_file_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            ...
                            new_molecules_df.to_csv('./result/KIT/KIT_new_molecules_file_by_compared_pocket_similarity_refined_filter_10000_nik.csv', index=None)
