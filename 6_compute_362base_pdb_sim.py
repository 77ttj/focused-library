...
print(result_vector)'''
 ...
 # 读取原始csv文件
df = pd.read_csv('./output_PDB_test_processed_select_ligandsplit_4_5_4.csv')
...
df.to_csv('output_PDB_test_processed_select_ligandsplit_4_5_4_compute_362base_sim_refined.csv', index=None)
