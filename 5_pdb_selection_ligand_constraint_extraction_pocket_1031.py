...
# 定义源文件夹路径和目标文件夹路径
src_folder = './PDB_processed_resolution_4_5_2/'
...
with open('output_PDB_test_processed_select_ligandsplit_4_5_4.csv', 'w', newline='') as output_file:
